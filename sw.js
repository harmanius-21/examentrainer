const CACHE='geschiedenis-v36';
const FILES=['./','./index.html','./style.css','./config.js?v=36','./questions.js?v=36','./app.js?v=36','./manifest.json','./logo.svg','./icon-192.png','./icon-512.png'];
