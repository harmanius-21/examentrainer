const CACHE='geschiedenis-v35';
const FILES=['./','./index.html','./style.css','./config.js?v=35','./questions.js?v=35','./app.js?v=35','./manifest.json','./logo.svg','./icon-192.png','./icon-512.png'];
