const CACHE='geschiedenis-v34';
const FILES=['./','./index.html','./style.css','./config.js?v=34','./questions.js?v=34','./app.js?v=34','./manifest.json','./logo.svg','./icon-192.png','./icon-512.png'];
